    ...
    items.add([
		...
		{id: 8, content: '<div style="display: flex; align-items: center;"><img src="img/ppke-logo.png" style="width:20px; height:30px; padding-right: 5px"><span style ="color:red; padding-right: 5px">Higher Education Analyst (Data Scientist)</span><span> at Pazmany Peter Catholic University</span></div>', start: '2014-06-01', end: new Date(), group:'foo'},
